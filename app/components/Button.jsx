          ...
          >
            ...
            >
              <Image
                ...
                className="absolute mr-[-16px] mt-[-15px] top-0 right-0 cursor-pointer"
              />
                    ...
                    <div className="flex flex-col space-y-4 mt-5">
                      ...
                      >
                        <button
                          ...
                          className={`w-[70%] bg-[#7000ff] mt-5 text-white font-medium px-[9%] sm:px-[10%] py-4 rounded-full flex items-center gap-2 shadow-md hover:bg-purple-700 hover:scale-105 justify-around transition-transform duration-200 ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""}`}
                        >
                          <p className="text-white text-center text-lg sm:text-2xl font-medium leading-normal">
