...
function page() {
  return (
    ...
    <h1 className="text-[#2f006b] text-[32px] font-semibold font-['Inter'] leading-9">Terms &amp; Condition</h1>
    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">OVERVIEW</h3>
    <p>This website is operated by Company. Throughout the site, the terms “we”, “us” and “our” refer to The
        Vibes
        Network. The Vibes Network offers this website, including all information, tools and Services available
        from
        this
        ...
        conditions
        and policies referenced herein and/or available by hyperlink. These Terms of Service apply to all users
        of
        the
        site, including without limitation users who are browsers, vendors, customers, merchants, and/ or
        contributors of
        content. Please read these Terms of Service carefully before accessing or using our website. By
        accessing or
        using
        ...
        Service
        are considered an offer, acceptance is expressly limited to these Terms of Service. Any new features or
        tools
        which are added to the current store shall also be subject to the Terms of Service. You can review the
        most
        current version of the Terms of Service at any time on this page. We reserve the right to update, change
        or
        replace any part of these Terms of Service by posting updates and/or changes to our website. It is your
        responsibility to check this page periodically for changes. Your continued use of or access to the
        website
        following the posting of any changes constitutes acceptance of those changes.</p>

    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">
        SECTION 1 - ONLINE STORE TERMS
    </h3>
    <p>By agreeing to these Terms of Service, you represent that you are at least the age of majority in your
        state
        or
        province of residence, or that you are the age of majority in your state or province of residence and
        you
        have
        given us your consent to allow any of your minor dependents to use this site. You may not use our
        products
        for any
        illegal or unauthorized purpose nor may you, in the use of the Service, violate any laws in your
        jurisdiction
        (including but not limited to copyright laws). A breach or violation of any of the Terms will result in
        an
        immediate termination of your Services.</p>

    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">SECTION 2 - GENERAL CONDITIONS</h3>
    ...
    <p>You understand that your content (not including credit card information), may be transferred unencrypted
        ...
        networks.
        You
        agree not to reproduce, duplicate, copy, sell, resell or exploit any portion of the Service, use of the
        Service,
        or access to the Service or any contact on the website through which the service is provided, without
        express
        written permission by us. The headings used in this agreement are included for convenience only and will
        not
        limit
        or otherwise affect these Terms.</p>

    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h3>
    <p>
        We are not responsible if the information made available on this site is not accurate, complete or
        current.
        The
        material on this site is provided for general information only and should not be relied upon or used as
        the
        sole
        basis for making decisions without consulting primary, more accurate, more complete or more timely
        sources
        of
        information. Any reliance on the material on this site is at your own risk. This site may contain
        certain
        historical information. Historical information, necessarily, is not current and is provided for your
        reference
        only. We reserve the right to modify the contents of this site at any time, but we have no obligation to
        update
    ...
    <p>Our products or Services are available exclusively online through the website, mobile application and
        other
        online platforms. These products or Services may have limited quantities and are subject to return or
        exchange
        only according to our Return Policy. To view our Return Policy, please visit RETURN POLICY. We have made
        every
        effort to display as accurately as possible the colours and images of our products that appear at the
        store.
        We
        cannot guarantee that your computer monitor's display of any colour will be accurate. We reserve the
        right,
        but
        ...
        quantities of
        any products or Services that we offer. All descriptions of products or product pricing are subject to
        change at
        any time without notice, at the sole discretion of us. We reserve the right to discontinue any product
        at
        any
        time. We do not warrant that the quality of any products, Services, information, or other material
        purchased
        or
        obtained by you will meet your expectations, or that any errors in the Service will be corrected.</p>

    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h3>
    <p>We reserve the right to refuse any order you place with us. We may, in our sole discretion, limit or
        ...
        at
        our
        online store. You agree to promptly update your account and other information, including your email
        address
        and
        credit card numbers and expiration dates, so that we can complete your transactions and contact you as
        needed. For
        more detail, please review our Returns Policy.</p>
    ...
    <p>Certain content, products and Services available via our Service may include materials from
        ...
        We
        are not
        responsible for examining or evaluating the content or accuracy and we do not warrant and will not have
        any
        ...
        websites.
        Please
        review carefully the third-party's policies and practices and make sure you understand them before you
        engage in
        any transaction. Complaints, claims, concerns, or questions regarding third-party products should be
        directed to
        the third-party. By using the third-party app ("the App") to access our courses, you agree that: The App
        is
        provided by Edmingle(app provider) and is subject to their terms and conditions. You agree to abide by
        the
        terms
        and conditions set forth by the App provider when using the App to access our courses. Our courses
        available
        through the App are subject to our terms of service and policies, in addition to any terms imposed by
        the
        App
        provider. Your access to our courses may be restricted or terminated if you violate either our terms or
        the
        terms
        of the App provider. You are required to create an account with the App provider to access our courses.
        For
        assistance with technical issues related to the App, please contact our customer support team. We are
        not
        responsible for the performance, functionality, or availability of the App. We do not warrant or
        guarantee
        that
        the App will be free from errors, interruptions, or defects. You agree to indemnify and hold us harmless
        from any
        claims, damages, liabilities, or expenses arising from your use of the App. We reserve the right to
        modify
        or
        update these terms and conditions at any time. Any changes will be effective immediately upon posting.
        Your
        continued use of the App to access our courses constitutes acceptance of the modified terms.</p>
    ...
    <p>If, at our request, you send certain specific submissions (for example contest entries) or without a
        request
        from
        us you send creative ideas, suggestions, proposals, plans, or other materials, whether online, by email,
        by
        postal
        mail, or otherwise (collectively, 'comments'), you agree that we may, at any time, without restriction,
        edit,
        copy, publish, distribute, translate and otherwise use in any medium any comments that you forward to
        us. We
        are
    ...
    <p> We may, but have no obligation to, monitor, edit or remove content that we determine in our sole
        discretion
        to
        be unlawful, offensive, threatening, libellous, defamatory, pornographic, obscene or otherwise
        objectionable
        or
        violates any party’s intellectual property or these Terms of Service., You agree that your comments will
        not
        ...
        unlawful,
        abusive
        or obscene material, or contain any computer virus or other malware that could in any way affect the
        operation of
        the Service or any related website. You may not use a false e-mail address, pretend to be someone other
        than
        yourself, or otherwise mislead us or third-parties as to the origin of any comments. You are solely
        responsible
        for any comments you make and their accuracy. We take no responsibility and assume no liability for any
        comments
    ...
    <p>
        Your submission of personal information through our website www.thevibes.network is
        governed by our Privacy Policy. To view our Privacy Policy, please see PRIVACY POLICY
    </p>
    ...
    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">Section 11- Prohibited Uses</h3>
    ...
    <p>(a) for any unlawful purpose; (b) to solicit others to perform or participate in any unlawful
        ...
        spam, phish, pharm, pretext, spider, crawl, or scrape; (j) for any obscene or immoral
    ...
    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">SECTION 12 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h3>
    ...
    <p>
        ...
        particular purpose, durability, title, and non-infringement. In no case shall The Vibes
        Network, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers,
        service providers or licensors be liable for any injury, loss, claim, or any direct, indirect,
        ...
        consequential or incidental damages, in such states or jurisdictions, our liability shall be
        limited to the maximum extent permitted by law.
    </p>



    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">SECTION 13 - INDEMNIFICATION</h3>
    <p>You agree to indemnify, defend and hold harmless The Vibes Network and our parent,
    ...
    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">SECTION 14 - SEVERABILITY</h3>
    ...
    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">SECTION 15- TERMINATION</h3>
    <p>The obligations and liabilities of the parties incurred prior to the termination date shall survive
        ...
        unless and until terminated by either you or us. You may terminate these Terms of Service
        at any time by notifying us that you no longer wish to use our Services, or when you cease
        using our site.</p>
    ...
    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">SECTION 16 - ENTIRE AGREEMENT</h3>
    <p>The failure of us to exercise or enforce any right or provision of these Terms of Service shall
        ...
        whether oral or written, between you and us (including, but not limited to, any prior versions
        of the Terms of Service).Any ambiguities in the interpretation of these Terms of Service shall
        not be construed against the drafting party.</p>



    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">SECTION 17 - GOVERNING LAW</h3>
    <p>These Terms of Service and any separate agreements whereby we provide you Services
        shall be governed by and construed in accordance with the laws of India. This agreement is
        governed by and construed in accordance with the laws of Delhi state. Any disputes arising
        from or in connection with this agreement will be subject to the exclusive jurisdiction of the
        courts of Delhi state</p>



    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">SECTION 18- CHANGES TO TERMS OF SERVICE</h3>
    ...
    <h3 className="text-[#000000] text-[25px] font-semibold mt-10 font-['Inter'] leading-9">SECTION 19 - CONTACT INFORMATION</h3>
    <p>Questions about the Terms of Service should be sent to us at connect@thevibes.network</p>
