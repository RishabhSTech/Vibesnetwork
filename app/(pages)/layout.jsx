...
const menu = [
  {
    ...
    link: "https://thevibes.network/#stats",
  },
  {
    title: "ABOUT US",
    link: "https://thevibes.network/#about-us",
  },
  {
    title: "MEET OUR STARS",
    link: "https://thevibes.network/#meet-stars",
  },
  {
    title: "OUR AI INFLUENCER SYSTEM",
    link: "https://thevibes.network/#ai-enabled",
  },
  {
    title: "INFLUENCER MARKETING IN INDIA",
    link: "https://thevibes.network/#influencer-marketing",
  },
  {
    title: "WHY CHOOSE US",
    link: "https://thevibes.network/#why-vibes",
  },
  {
    title: "TEAM",
    link: "https://thevibes.network/#lead",
  },
  {
    ...
    <>
      <div className="flex flex-col sm:mb-0 mb-5">
          <div className="flex justify-between items-center py-12 px-12 ">
            <Image src="./assets/vibesLight.svg" width={170} height={100} alt="logo" />
            <span className="flex w-1/2 max-w-[411px] flex-row justify-around items-center">
              <button onClick={() => window.open("/blogs")} className="hidden sm:flex min-w-[95.42px] min-h-[37.49px]  flex-row rounded-[20px] border border-[#46009e] items-center justify-around px-3 hover:bg-[#46009e] transition-all duration-300 group">
                <p className=" text-center text-[#46009e] text-base font-normal group-hover:text-white">
                  Blog
                </p>
                <svg
                  width="19"
                  ...
                  viewBox="0 0 19 18"
                  fill="currentColor"
                  className="text-[#46009e] group-hover:text-white"
              ...
              <button
              onClick={() => setIsOpen2(!isOpen2)} className="hidden sm:inline w-[210.89px] group min-h-[37.49px] rounded-[20px] border border-[#46009e] hover:bg-[#46009e] transition-all duration-300">
                <p className="text-center text-[#46009e] text-base font-normal group-hover:text-white">
              ...
              >
                <div className="w-[40.36px] group h-[40.36px] left-0 top-0 absolute bg-white rounded-full border border-[#46009e] transition-all duration-300 group-hover:bg-[#7000ff]"></div>
                <div
                  data-svg-wrapper
                ...
                <AnimatePresence>
                  {isOpen && (
                    <motion.div
                      ...
                      className="w-[506.53px] border-2 border-purple-600 pt-[20px] px-[47px] hidden sm:inline-block absolute right-0 mt-16 z-20 shadow-lg p-4 bg-white rounded-[20px] backdrop-blur-[134.35px]"
                    >
                      <motion.div
                      ...
                      >
                        {menu.map((item, index) => (
                          <motion.div
                            ...
                            className="mt-2 "
                          >
                            <a href={item.link} className="hover:text-purple-600 mt-2 cursor-pointer w-full text-purple-600 text-[22px] font-medium font-['Inter'] leading-normal">
      ...
      <path d="M0.5 1H471" stroke="#B982FF" stroke-width="0.5" strokeDasharray="5 5"/>
              ...
              {isOpen2 && (
                ...
                exit={{ opacity: 0 }}
              >
                <div className="relative scale-75 sm:sc md:h-[476.53px] sm:p-0 p-5 sm:h-[300px] flex flex-col sm:flex-row max-w-[908.76px] w-[80%] bg-white/80 items-center justify-evenly rounded-[20px] backdrop-blur-[134.35px]">
                  {/* Close Button */}
                 <Image src="/assets/close.svg" width={40} height={40} alt="close" onClick={() => setIsOpen2(!isOpen2)} className="absolute mr-[-16px] mt-[-15px] top-0 right-0 cursor-pointer" />
                  ...
                  <div className="sm:w-[45%] sm:p-0 p-5 flex flex-col sm:h-[80%] md:h-[428.54px] bg-white rounded-[20px]">
                  ...
                  <div className="sm:w-[45%] sm:mt-0 mt-5 sm:p-0 p-5 sm:h-[80%] md:h-[428.54px] bg-white rounded-[20px]">
          ...
          <div
          className={`sm:hidden relative z-20 shadow-2xl overflow-hidden transition-all duration-300 ease-in-out ${
            isOpen ? "h-[550px]" : "h-0"
          }`}
        >
          {menu.map((item, index) => (
            <a
              href={item.link}
              key={index}
              className="block bg-white text-[#46009e] text-lg font-semibold leading-[45px] text-center border-b border-[#46009e] py-2"
            >
              {item.title}
            </a>
          ))}
